function(gen_param_lib LIB_NAME YAML_FILE)
  ...
  add_custom_command(
    ...
    COMMAND ${gen_param_lib_BIN} ${PARAM_HEADER_FILE} ${CMAKE_CURRENT_SOURCE_DIR}/${YAML_FILE} ${CMAKE_CURRENT_SOURCE_DIR}/${VALIDATE_HEADER}
    DEPENDS ${CMAKE_CURRENT_SOURCE_DIR}/${YAML_FILE} ${CMAKE_CURRENT_SOURCE_DIR}/${VALIDATE_HEADER}
    COMMENT
    "Running `${gen_param_lib_BIN} ${PARAM_HEADER_FILE} ${CMAKE_CURRENT_SOURCE_DIR}/${YAML_FILE} ${CMAKE_CURRENT_SOURCE_DIR}/${VALIDATE_HEADER}`"
    VERBATIM
  )
